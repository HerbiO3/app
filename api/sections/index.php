...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if(isset($_GET["sectionId"]) && $_GET["history"]){
        ...
        if($_GET["sectionId"] == 5){
            echo '{"time": '.$t.', "id": 5, "name": "Kvetináč 1", "unitName": "Fakulta chodba", "waterLevel": 0.5, "uvIndex": 1, "airTemperature": 21, "humidity": [ { "sensorId": 3, "value":0.61 }, { "sensorId": 4, "value":0.63 } ] }';
            return;
        }else{
